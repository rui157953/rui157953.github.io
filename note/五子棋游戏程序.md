...
### MainActivity
```
public class MainActivity extends AppCompatActivity implements GobangView.OnResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gobangView = findViewById(R.id.gv);
        gobangView.setOnResultListener(this);
    }

    @Override
    public void onResult(boolean firstWin, boolean lastWin) {
        String text = firstWin ? "黑棋胜！" : "白棋胜";
    ...
    private void showNormalDialog(String text) {
        ...
        normalDialog.setPositiveButton("再来一局",
    ...
    public void undo(View view) {
        switch (view.getId()){
            case R.id.bUndo:
                gobangView.undoBlack();
                break;
            case R.id.wUndo:
                gobangView.undoWhite();
                break;
        }
    }
}
...
<android.support.constraint.ConstraintLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    tools:context="com.ryan.mygobang.MainActivity"
    tools:layout_editor_absoluteY="81dp">

    <com.ryan.mygobang.GobangView
        android:id="@+id/gv"
...
//        animator = ValueAnimator.ofInt(bitmapPaint,"Alpha",);
    ...
    private Bitmap getBitmapFromRes(Resources resources, int resId, int reqWidth, int reqHeight) {
    ...
    interface OnResultListener{
        void onResult(boolean firstWin,boolean lastWin);
    }
